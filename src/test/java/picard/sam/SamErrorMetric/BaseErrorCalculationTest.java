...
public class BaseErrorCalculationTest {
    ...
    public void testSimpleErrorCalculator() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            baseErrorCalculator.addBase(recordAndOffset, locusAndReference, CollectSamErrorMetrics.BaseOperation.Match);
        }
    ...
    public void testOverlappingErrorCalculator() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            overlappingErrorCalculator1.addBase(recordAndOffset1, locusAndReference, CollectSamErrorMetrics.BaseOperation.Match);
            overlappingErrorCalculator2.addBase(recordAndOffset2, locusAndReference, CollectSamErrorMetrics.BaseOperation.Match);
        }
        ...
        try (final ReferenceSequenceFileWalker referenceSequenceFileWalker =
            ...
            for (final SamLocusAndReferenceIterator.SAMLocusAndReference locusAndReference : samLocusAndReferences) {
                for (SamLocusIterator.RecordAndOffset recordAndOffset : locusAndReference.getRecordAndOffsets())
                    ...
                    aggregation.addBase(recordAndOffset, locusAndReference, CollectSamErrorMetrics.BaseOperation.Match);
            }
        }
    }
}
