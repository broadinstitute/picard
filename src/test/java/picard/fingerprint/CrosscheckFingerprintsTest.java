...
public class CrosscheckFingerprintsTest {
    ...
    private static File NA12892_2_hg38_vcf;
    ...
    public void setup() throws IOException {
        ...
        NA12891_1_hg38_vcf = VcfTestUtils.createTemporaryIndexedVcfFromInput(new File(TEST_DIR, "NA12891_hg38.vcf"), "fingerprint");
        NA12891_2_hg38_vcf = VcfTestUtils.createTemporaryIndexedVcfFromInput(new File(TEST_DIR, "NA12891.fp_hg38.vcf"), "fingerprint");
        NA12892_1_hg38_vcf = VcfTestUtils.createTemporaryIndexedVcfFromInput(new File(TEST_DIR, "NA12892_hg38.vcf"), "fingerprint");
        NA12892_2_hg38_vcf = VcfTestUtils.createTemporaryIndexedVcfFromInput(new File(TEST_DIR, "NA12892.fp_hg38.vcf"), "fingerprint");
    ...
    public Object[][] filesSources() {
        ...
        return new Object[][]{
                {NA12891_r1, NA12891_r2, 0, 2*2},
                {NA12892_r1, NA12892_r2, 0, 2*2},
                {NA12891_r1, NA12892_r1, 0, 2*2},
                {NA12892_r2, NA12891_r2, 0, 2*2},
                {NA12892_r2, NA12891_named_NA12892_r1, 1, 2*2}, // the two files contain different samples one has wrong name
                {NA12891_r2, NA12891_named_NA12892_r1, 1, 2*2}, // unexpected match
                {NA12892_r1, NA12891_named_NA12892_r1, 1, 2*2}, // the two files contain different samples one has wrong name
                {NA12891_r1, NA12891_named_NA12892_r1, 1, 2*2}, // unexpected match
                {NA12891_1_vcf, NA12891_2_vcf, 0, 2*2},
                {NA12891_2_vcf, NA12891_2_vcf, 0, 1},
                {NA12891_1_vcf, NA12891_1_vcf, 0, 1},
                {NA12892_1_vcf, NA12892_2_vcf, 0, 2*2},
                {NA12892_1_vcf, NA12892_1_vcf, 0, 1},
                {NA12892_2_vcf, NA12892_2_vcf, 0, 1},
                {NA12891_2_vcf, NA12892_2_vcf, 0, 2*2},
                {NA12892_1_vcf, NA12891_2_vcf, 0, 2*2}
        };
    }
    ...
    public Iterator<Object[]> checkSamplesCrosscheckAllWithMappingData() {
        ...
        File NA12892_to_NA12891 = new File(TEST_DIR,"NA12892_to_NA12891.txt");
        File NotThere_to_NA12892 = new File(TEST_DIR,"NotThere_to_NA12891.txt");
    ...
    public Iterator<Object[]> checkSampleMapFailuresData() {
        ...
        File NA12892_to_NA12891 = new File(TEST_DIR,"NA12892_to_NA12891.txt");
        File NA12891_to_NA12892 = new File(TEST_DIR,"NA12891_to_NA12892.txt");
        File tooManyFields = new File(TEST_DIR,"too_many_fields.txt");
        File tooFewFields = new File(TEST_DIR,"too_few_fields.txt");
        File duplicateKey = new File(TEST_DIR,"DuplicateKey.txt");
    ...
    public Iterator<Object[]> checkPathsData() throws IOException {
        ...
        // VCF tests
        tests.add(new Object[]{Stream.of(NA12891_1_vcf, NA12892_1_vcf, NA12891_g_vcf, NA12892_g_vcf).map(File::getAbsolutePath).collect(Collectors.toList()), HAPLOTYPE_MAP_HG19.getAbsolutePath(), 0, 4 * 4, false});
        tests.add(new Object[]{Stream.of(NA12892_1_vcf, NA12891_g_vcf, NA12892_g_vcf).map(File::getAbsolutePath).collect(Collectors.toList()), HAPLOTYPE_MAP_HG19.getAbsolutePath(), 0, 3 * 3, false});
        tests.add(new Object[]{Collections.singletonList(fofn.getAbsolutePath()), HAPLOTYPE_MAP_HG19.getAbsolutePath(), 0, fofnSize * fofnSize, false});
    ...
    public Iterator<Object[]> multipleReferenceFilesData(){
        ...
        tests.add(new Object[]{Arrays.asList(NA12891_2_hg38_vcf, NA12892_g_vcf), 0, 2 * 2, false});
        tests.add(new Object[]{Arrays.asList(NA12891_2_hg38_vcf, NA12891_g_vcf), 0, 2 * 2, false});
        tests.add(new Object[]{Arrays.asList(NA12892_1_hg38_vcf, NA12891_g_vcf), 0, 2 * 2, true});
        tests.add(new Object[]{Arrays.asList(NA12892_1_hg38_vcf, NA12892_g_vcf), 0, 2 * 2, true});
        tests.add(new Object[]{Arrays.asList(NA12891_2_hg38_vcf, NA12891_1_vcf), 0, 2 * 2, true});
