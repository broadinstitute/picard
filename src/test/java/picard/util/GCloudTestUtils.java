...
public final class GCloudTestUtils {
    ...
    public static final PicardHtsPath TEST_INPUTS_DEFAULT = new PicardHtsPath("gs://hellbender/test/resources/"); // chris: turn these to PicardHtsPath
    ...
    public static final PicardHtsPath TEST_OUTPUT_DEFAULT = PicardHtsPath.resolve(TEST_STAGING_DEFAULT, "picard/"); // tsato: this right?
    ...
    public static String getTestStaging() {
        return getSystemProperty("PICARD_TEST_STAGING", TEST_STAGING_DEFAULT.getURIString());
    }
    ...
    public static String getTestInputPath() {
        return getSystemProperty("PICARD_TEST_INPUTS", TEST_INPUTS_DEFAULT.getURIString());
    }
