...
public class TargetedPcrMetrics extends MultilevelMetrics {
    ...
    /** The fraction of TOTAL_READS that are unique, PF, and without duplicates, PF_UNIQUE_READS/TOTAL_READS */
    ...
    /**
     * The fraction of bases mapping to regions on or near amplicons, which mapped directly to but not near amplicons,
     * ON_AMPLICON_BASES/(NEAR_AMPLICON_BASES + ON_AMPLICON_BASES)
     * */
