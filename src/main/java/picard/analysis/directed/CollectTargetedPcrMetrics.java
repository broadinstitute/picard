...
/**
 * <p>This tool calculates a set of PCR-related metrics from an aligned SAM or
 ...
 * <a href='http://broadinstitute.github.io/picard/picard-metric-definitions.html#TargetedPcrMetrics'>{@link TargetedPcrMetrics} </a>
 * for detailed explanations of the output metrics produced by this tool.
 * <hr />
 *
 * Collect metric information for target pcr metrics runs.  See {@link CollectTargetedMetrics} and {@link TargetedPcrMetricsCollector} for
 * more information
 *
 */
