...
@CommandLineProgramProperties(
        summary = "Reverts the original base qualities and adds the mate cigar tag to read-group SAM, BAM or CRAM files.",
        oneLineSummary = "Reverts the original base qualities and adds the mate cigar tag to read-group SAM, BAM or CRAM files",
