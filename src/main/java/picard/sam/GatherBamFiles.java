...
public class GatherBamFiles extends CommandLineProgram {
    ...
    @Argument(shortName = StandardOptionDefinitions.INPUT_SHORT_NAME,
            doc = "Two or more SAM/BAM/CRAM files or text files containing lists of SAM/BAM/CRAM files (one per line).")
    public List<File> INPUT;

    @Argument(shortName = StandardOptionDefinitions.OUTPUT_SHORT_NAME, doc = "The output SAM/BAM/CRAM file to write.")
    public File OUTPUT;
