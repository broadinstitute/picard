...
public enum NGSPlatform {
     ...
     */
    public static NGSPlatform fromRead(final SAMRecord read, final SAMFileHeader header ) {
        return fromReadGroupPL(getPlatform(read, header));
    }
    ...
    private static String getPlatform( final SAMRecord read, final SAMFileHeader header ) {
